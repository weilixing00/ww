...
//        textSize = 0;
        textSize = 16;
        colorGray = 0xff969696;
        colorBlack = 0xff323232;
        colorGrayLight = 0xffc5c5c5;
        l = 2.0F;
        isLoop = true;
        positon = -1;
        r = 9;// 半径 影响弹框的高度  也影响到选择的内容
        x = 0.0F;
        y = 0.0F;
        z = 0.0F;
        totalScrollY = 0;
...
//            canvas.drawLine(0.0F, o, v, o, paintC);
            //画中间的两条横线
            canvas.drawLine(0.0F, n - 5, v, n - 5, paintC);
            canvas.drawLine(0.0F, o + 15, v, o + 15, paintC);
            int j1 = 0;
            while (j1 < r) {
                canvas.save();
...
//                    double zoom = ((double) textSize - str.length()*2) / textSize * 1.2;
                    ...
                    double zoom = ((double) textSize - str.length() * 2) / textSize * 1.1;
...
//                    }
                    ...
                    //设置字体水平居中
                    if (itemWidth > 0) {
                        startX += (maxWidth - rect.width()) * 0.5;
                    }
